...
from app.classifiers.common_torch import CrossEntropyLossLe
...
def train_lstm(
    ...
    accuracy_top1 = Accuracy(output_transform=lambda x: (x[0], x[1]), device=device)
